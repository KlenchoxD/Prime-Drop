    ...
    (function() {
      ...
      function injectLateStyle() {
        ...
        style.textContent = [
          ...
          '@media (max-width:900px){body:not(.single-product) .woocommerce ul.products li.product .ct-woo-card-actions,body:not(.single-product) .woocommerce ul.products li.product .button{opacity:1!important;visibility:visible!important;transform:none!important}}'
        ].join('\n');
