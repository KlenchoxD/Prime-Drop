...
add_action('wp_head', function () {
    ...
    .pd-footer-contact .pd-footer-email-link {
      display: inline-flex !important;
      align-items: center !important;
      gap: 9px !important;
      color: #ffffff !important;
    ...
    .pd-footer-contact .pd-footer-email-link:hover {
      opacity: .75 !important;
    }

    .pd-footer-contact .pd-footer-email-link svg {
...
add_action('wp_footer', function () {
    ...
    (function() {
      function updatePrimeDropFooterContact() {
        document.querySelectorAll('.pd-footer-contact').forEach(function(column) {
          if (column.dataset.pdContactPoliciesReady === '1') return;
          column.dataset.pdContactPoliciesReady = '1';

          column.innerHTML =
            '<h4>CONTACTO</h4>' +
            '<a class="pd-footer-email-link" href="mailto:primedropelite@gmail.com" aria-label="Enviar correo a Prime Drop">' +
              '<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M4 6.5h16v11H4z" stroke-width="1.8" stroke-linejoin="round"></path><path d="m4.8 7.2 7.2 5.6 7.2-5.6" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path></svg>' +
              '<span>primedropelite@gmail.com</span>' +
            '</a>' +
      ...
      document.addEventListener('DOMContentLoaded', updatePrimeDropFooterContact);
      setTimeout(updatePrimeDropFooterContact, 250);
      setTimeout(updatePrimeDropFooterContact, 1000);
      setTimeout(updatePrimeDropFooterContact, 2000);
    })();
    </script>
    <?php
}, 1002);
