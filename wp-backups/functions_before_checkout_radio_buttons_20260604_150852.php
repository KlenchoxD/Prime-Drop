...
add_action('wp_head', function() {
    ...
    /* Fuente global Prime Drop */
    body,
    body *:not(svg):not(path):not(i):not(.dashicons):not([class*="icon"]):not([class*="Icon"]) {
    ...
    /* Bolita de seleccion: negro con punto blanco */
    body.woocommerce-checkout input[type="radio"],
    body.woocommerce-page input[type="radio"],
    body.woocommerce-checkout #payment ul.payment_methods li input[type="radio"],
    body.woocommerce-checkout input.input-radio,
    ...
    body.woocommerce-checkout input.input-radio:checked,
    body.woocommerce-checkout input[name="payment_method"]:checked {
      border-color: #000000 !important;
    ...
    body.woocommerce-checkout input.input-radio:focus,
    body.woocommerce-checkout input[name="payment_method"]:focus {
    ...
    @media (min-width: 768px) and (max-width: 1024px) {
      ...
      .ct-header-cart .ct-cart-content,
      .ct-header-trigger .ct-icon-container {
