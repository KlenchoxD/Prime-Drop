...
/* ---------- 3. BUSCADOR EN TIENDA REMOVIDO POR PRIME_DROP_VISUAL_POLISH_20260606 ---------- */
...
add_filter('the_content', function($content) {
    ...
    $old_source = '<source src="https://primedropelite.com/wp-content/uploads/2026/06/prime-drop-hero-1080p-24fps-hq.mp4" type="video/mp4">';
    $new_source = '<source src="' . esc_url('https://primedropelite.com/wp-content/uploads/2026/06/prime-drop-hero-1080p-24fps-hq.mp4') . '" type="video/mp4">';
    $content = str_replace($old_source, $new_source, $content);
    $content = str_replace('https://primedropelite.com/wp-content/uploads/2026/06/prime-drop-hero-1080p-24fps-hq.mp4', esc_url('https://primedropelite.com/wp-content/uploads/2026/06/prime-drop-hero-1080p-24fps-hq.mp4'), $content);
    return $content;
}, 999);
...
add_action('wp_footer', function() {
    ...
    (function() {
      var newUrl = "https://primedropelite.com/wp-content/uploads/2026/06/prime-drop-hero-1080p-24fps-hq.mp4";
      function run() {
    ...
    *::after {
    ...
    (function() {
      ...
      function run() {
        ...
        /* addHeaderSearchIcon() removido por PRIME_DROP_VISUAL_POLISH_20260606 */
...
/* PRIME_DROP_VISUAL_POLISH_20260606_START */
...
add_action('wp_head', function() {
    ...
    ?>
    <style id="prime-drop-visual-polish-20260606">
    html {
    ...
    #pd-client-topbar a,
    #pd-client-topbar .pd-client-topbar-email,
    #pd-client-topbar .pd-client-topbar-socials,
    #pd-client-topbar .pd-client-topbar-socials span,
    #pd-client-topbar .pd-client-topbar-socials a {
      display: none !important;
    }

    #pd-client-topbar .pd-client-topbar-email::before {
      content: none !important;
    }

    #pd-client-topbar .pd-client-topbar-phrases {
      position: static !important;
      min-width: 0 !important;
      min-height: 0 !important;
      width: auto !important;
    ...
    #pd-client-topbar .pd-client-topbar-phrases span {
      display: none !important;
      position: static !important;
    ...
    #pd-client-topbar .pd-client-topbar-phrases span:nth-child(3) {
      display: inline !important;
    }

    #header .pd-header-search-link,
    header .pd-header-search-link,
    .pd-header-search-link,
    ...
    @media (min-width: 1000px) {
      ...
      #header [data-device="desktop"] .pd-bolsos-submenu a::after {
        content: "→" !important;
    ...
    .pd-listing-brand-rail::-webkit-scrollbar {
      display: none !important;
    }

    .pd-listing-brand-rail a {
      min-height: 34px !important;
      display: inline-flex !important;
      align-items: center !important;
      justify-content: center !important;
    ...
    .pd-listing-brand-rail a:hover,
    .pd-listing-brand-rail a:focus,
    .pd-listing-brand-rail a.is-active {
    ...
    body.page-id-547 .woo-listing-top .woocommerce-ordering::before,
    body.tax-product_cat .woo-listing-top .woocommerce-ordering::before,
    body.woocommerce-shop .woo-listing-top .woocommerce-ordering::before,
    body.post-type-archive-product .woo-listing-top .woocommerce-ordering::before {
    ...
    body.page-id-547 .woocommerce ul.products.products,
    ...
    body:not(.single-product) .woocommerce ul.products li.product a.ct-media-container,
    body:not(.single-product) ul.products li.product a.woocommerce-loop-product__link {
      width: 100% !important;
      aspect-ratio: 4 / 5 !important;
      min-height: 0 !important;
      height: auto !important;
    ...
    body:not(.single-product) .woocommerce ul.products li.product:not(:hover) .ct-woo-card-actions,
    body:not(.single-product) .woocommerce ul.products li.product:not(:hover) .button,
    body:not(.single-product) .woocommerce ul.products li.product:hover .ct-woo-card-actions,
    ...
    body.single-product .pd-client-share,
    body.single-product .pswp__button--share,
    body.single-product .pswp__share-modal,
    body.single-product .pd-client-reviews {
      display: none !important;
    }
...
add_action('wp_footer', function() {
    ...
    ?>
    <style id="prime-drop-visual-polish-20260606-footer-css">
    #header .pd-header-search-link,
    header .pd-header-search-link,
    .pd-header-search-link,
    #header [data-id="search"],
    ...
    body.woocommerce-shop .pd-shop-search,
    body.post-type-archive-product .pd-shop-search,
    body.page-id-547 .woo-listing-top .pd-shop-search,
    body.tax-product_cat .woo-listing-top .pd-shop-search,
    body.woocommerce-shop .woo-listing-top .pd-shop-search,
    body.post-type-archive-product .woo-listing-top .pd-shop-search {
      display: none !important;
      visibility: hidden !important;
      opacity: 0 !important;
      pointer-events: none !important;
    ...
    body.page-id-547 .woo-listing-top .pd-listing-brand-rail,
    body.tax-product_cat .woo-listing-top .pd-listing-brand-rail,
    body.woocommerce-shop .woo-listing-top .pd-listing-brand-rail,
    body.post-type-archive-product .woo-listing-top .pd-listing-brand-rail {
      grid-area: rail !important;
      display: flex !important;
      align-items: center !important;
      gap: 8px !important;
    ...
    body.page-id-547 .woo-listing-top .woocommerce-ordering .ct-sort-icon,
    body.tax-product_cat .woo-listing-top .woocommerce-ordering .ct-sort-icon,
    body.woocommerce-shop .woo-listing-top .woocommerce-ordering .ct-sort-icon,
    body.post-type-archive-product .woo-listing-top .woocommerce-ordering .ct-sort-icon {
      display: none !important;
    }
    ...
    <script id="prime-drop-visual-polish-20260606-js">
    (function() {
      var brandItems = [
        ['TODOS', '/bolsos/', 'bolsos'],
        ['KARL LAGERFELD', '/product-category/karl-lagerfeld/', 'karl-lagerfeld'],
        ['MICHAEL KORS', '/product-category/michael-kors/', 'michael-kors'],
        ['STEVE MADDEN', '/product-category/steve-madden/', 'steve-madden'],
        ['TOMMY HILFIGER', '/product-category/tommy-hilfiger/', 'tommy-hilfiger']
      ];
      ...
      var sortLabels = {
        ...
        'Ordenar por calificación media': 'MEJOR CALIFICADOS',
        'Ordenar por las últimas': 'NUEVOS',
        'Ordenar por precio: bajo a alto': 'PRECIO MENOR',
        'Ordenar por precio: alto a bajo': 'PRECIO MAYOR'
      };

      function activeSlug() {
        var path = window.location.pathname.replace(/\/+$/, '').split('/').filter(Boolean);
        if (path.length === 1 && path[0] === 'bolsos') return 'bolsos';
        return path[path.length - 1] || 'bolsos';
      }

      function brandRailHtml() {
        var current = activeSlug();
        return brandItems.map(function(item) {
          var active = item[2] === current ? ' is-active' : '';
          return '<a class="' + active.trim() + '" href="' + item[1] + '">' + item[0] + '</a>';
        }).join('');
      }

      function cleanupSearch() {
        document.querySelectorAll('.pd-header-search-link, #header [data-id="search"], header [data-id="search"], #header .ct-header-search, header .ct-header-search, #header .dgwt-wcas-search-wrapp, header .dgwt-wcas-search-wrapp, .woo-listing-top .pd-shop-search').forEach(function(el) {
          el.remove();
        });
      }

      function cleanSortLabels() {
        document.querySelectorAll('select.orderby option').forEach(function(option) {
          var key = (option.textContent || '').replace(/\s+/g, ' ').trim();
          if (sortLabels[key]) option.textContent = sortLabels[key];
          option.style.textAlign = 'left';
          option.style.textAlignLast = 'left';
        });
      }

      function normalizeListingControls() {
        document.querySelectorAll('.woo-listing-top').forEach(function(top) {
          top.querySelectorAll('.pd-shop-search').forEach(function(search) {
            search.remove();
          });

          var ordering = top.querySelector('.woocommerce-ordering');
          var count = top.querySelector('.woocommerce-result-count');
          if (!ordering || !count) return;

          var rail = top.querySelector('.pd-listing-brand-rail');
          if (!rail) {
            rail = document.createElement('nav');
            rail.className = 'pd-listing-brand-rail';
            rail.setAttribute('aria-label', 'Categorías de bolsos');
            top.insertBefore(rail, top.firstElementChild);
          }
          rail.innerHTML = brandRailHtml();

          if (top.firstElementChild !== rail) top.insertBefore(rail, top.firstElementChild);
          if (top.lastElementChild !== ordering) top.appendChild(ordering);
          if (rail.nextElementSibling !== count) rail.insertAdjacentElement('afterend', count);

          top.style.setProperty('display', 'grid', 'important');
          top.style.setProperty('grid-template-columns', 'minmax(0, 1fr) auto', 'important');
          top.style.setProperty('grid-template-areas', '"rail order" "count order"', 'important');
          top.style.setProperty('gap', '10px 24px', 'important');
          top.style.setProperty('align-items', 'center', 'important');

          rail.style.setProperty('grid-area', 'rail', 'important');
          count.style.setProperty('grid-area', 'count', 'important');
          ordering.style.setProperty('grid-area', 'order', 'important');
          ...
          count.style.setProperty('text-align', 'left', 'important');
          ordering.style.setProperty('float', 'none', 'important');
          ordering.style.setProperty('margin', '0', 'important');

          ordering.querySelectorAll('.ct-sort-icon').forEach(function(icon) {
            icon.remove();
          });

          var select = ordering.querySelector('select.orderby');
          if (select) {
            select.style.setProperty('appearance', 'none', 'important');
            select.style.setProperty('-webkit-appearance', 'none', 'important');
            select.style.setProperty('min-width', '148px', 'important');
            select.style.setProperty('max-width', '170px', 'important');
            select.style.setProperty('height', '38px', 'important');
            select.style.setProperty('border', '0', 'important');
            select.style.setProperty('border-radius', '0', 'important');
            select.style.setProperty('border-bottom', '1px solid #0a0a0a', 'important');
            select.style.setProperty('background', 'transparent', 'important');
            select.style.setProperty('background-image', 'none', 'important');
            select.style.setProperty('box-shadow', 'none', 'important');
            select.style.setProperty('padding', '0 28px 0 0', 'important');
            select.style.setProperty('text-align', 'left', 'important');
            select.style.setProperty('text-align-last', 'left', 'important');
          }
        });
      }
      ...
      function normalizeSubmenus() {
        ...
        document.querySelectorAll('.pd-bolsos-menu-parent > .pd-bolsos-submenu').forEach(function(submenu) {
          if (submenu.dataset.pdListingCleanup === '1') return;
          submenu.innerHTML = menuHtml;
          submenu.dataset.pdListingCleanup = '1';
        });
      }

      function removeBounce() {
        document.querySelectorAll('.pd-category-grid, .pd-category-grid *, .pd-category-card, .pd-category-card *, body:not(.single-product) .woocommerce ul.products li.product, body:not(.single-product) .woocommerce ul.products li.product *').forEach(function(el) {
          el.style.setProperty('transform', 'none', 'important');
      ...
      function stopHeaderJank() {
        document.documentElement.style.setProperty('scroll-behavior', 'auto', 'important');
        document.documentElement.style.setProperty('overflow-anchor', 'none', 'important');
        document.querySelectorAll('#header [data-sticky], #header .ct-sticky-container, #header [data-row], #header [data-row] > div').forEach(function(el) {
          el.style.setProperty('transform', 'none', 'important');
          el.style.setProperty('animation', 'none', 'important');
          el.style.setProperty('will-change', 'auto', 'important');
        });
        if (!window.location.hash && window.scrollY > 0 && window.scrollY < 12) {
          window.scrollTo(0, 0);
        }
      }
      ...
      function cleanupProductPage() {
        if (!document.body.classList.contains('single-product')) return;
        document.querySelectorAll('.additional_information_tab, #tab-additional_information, .woocommerce-Tabs-panel--additional_information, .pd-client-share, .pd-client-reviews, .pswp__button--share, .pswp__share-modal').forEach(function(el) {
          el.remove();
        });
      }
      ...
      window.addEventListener('pageshow', run);
      window.addEventListener('load', run);
      window.addEventListener('scroll', stopHeaderJank, { passive: true });
      document.addEventListener('click', function() { setTimeout(run, 120); }, true);
      if (window.MutationObserver) {
        var scheduled = false;
        new MutationObserver(function() {
...
/* PRIME_DROP_VISUAL_POLISH_20260606_END */
