...
add_filter('the_content', function($content) {
    ...
    $old_urls = ['https://videos.pexels.com/video-files/6649983/6649983-uhd_2732_1440_25fps.mp4', 'https://primedropelite.com/wp-content/uploads/2026/06/prime-drop-hero-720p-24fps.mp4', 'https://primedropelite.com/wp-content/uploads/2026/06/IMG_14355.mp4'];
    foreach ($old_urls as $old_url) {
        $content = str_replace($old_url, 'https://primedropelite.com/wp-content/uploads/2026/06/prime-drop-hero-1080p-24fps-hq.mp4', $content);
    }
    $content = preg_replace('/<video([^>]*class=["\'][^"\']*pd-hero-video-bg[^"\']*["\'][^>]*)\s+poster=["\'][^"\']*["\']([^>]*)>/i', '<video$1$2>', $content);
    return $content;
}, 1300);
...
add_action('wp_footer', function() {
    ...
    (function() {
      var oldUrls = ['https://videos.pexels.com/video-files/6649983/6649983-uhd_2732_1440_25fps.mp4', 'https://primedropelite.com/wp-content/uploads/2026/06/prime-drop-hero-720p-24fps.mp4', 'https://primedropelite.com/wp-content/uploads/2026/06/IMG_14355.mp4'];
      ...
      function run() {
        document.querySelectorAll('.pd-hero video, video.pd-hero-video-bg').forEach(function(video) {
          ...
          video.querySelectorAll('source').forEach(function(source) {
            if (oldUrls.indexOf(source.getAttribute('src')) !== -1) source.setAttribute('src', newUrl);
          });
          if (oldUrls.indexOf(video.currentSrc) !== -1 || oldUrls.indexOf(video.src) !== -1) video.src = newUrl;
        });
      }
      run();
      document.addEventListener('DOMContentLoaded', run);
