    ...
    (function() {
      function updatePrimeDropFooterPoliciesAndSocialEmail() {
        ...
        document.querySelectorAll('.pd-footer-social-column .pd-social-icons').forEach(function(icons) {
          if (icons.querySelector('.pd-social-email')) return;
          ...
          email.innerHTML =
            '<svg viewBox="0 0 24 24" fill="none" aria-hidden="true">' +
              '<path d="M4.5 6.5h15v11h-15z" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"></path>' +
              '<path d="M5.2 7.2 12 12.4l6.8-5.2" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path>' +
              '<path d="M5.2 17.1V8.2l6.8 5.2 6.8-5.2v8.9" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path>' +
            '</svg>';
