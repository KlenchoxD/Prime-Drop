...
add_action('wp_footer', function() {
    ...
    (function() {
      function movePrivacyBelowRegister() {
        ...
        modal.querySelectorAll('.woocommerce-form-register, .ct-register-form, form.register').forEach(function(form) {
          var privacy = form.querySelector('.woocommerce-privacy-policy-text');
          var submit = form.querySelector('button[type="submit"], input[type="submit"], .ct-button[type="submit"]');
