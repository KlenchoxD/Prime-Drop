...
add_action('wp_footer', function() {
    ...
    /* /bolsos/: estructura visual igual a la pagina anterior */
    body.page-id-547 .woo-listing-top {
      max-width: 820px !important;
      margin: 88px auto 22px !important;
      padding: 0 !important;
      display: flex !important;
      justify-content: flex-end !important;
      align-items: center !important;
    ...
    body.page-id-547 .woocommerce-ordering::before {
    ...
    body.page-id-547 .woocommerce ul.products li.product .button,
    body.page-id-547 .woocommerce ul.products li.product:hover .button,
    body.page-id-547 .woocommerce ul.products li.product a.add_to_cart_button {
      display: none !important;
    }

    /* Home DESTACADAS: misma forma visual de imagen/titulo/precio */
    ...
    body.page-id-14 .woocommerce-page ul.products li.product a img,
    body.page-id-14 .woocommerce-page ul.products li.product img {
      width: 100% !important;
      aspect-ratio: 4 / 5 !important;
      height: auto !important;
      min-height: 0 !important;
