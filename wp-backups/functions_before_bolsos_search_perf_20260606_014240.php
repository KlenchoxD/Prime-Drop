...
add_filter('the_content', function($content) {
    ...
    $content = preg_replace_callback('/<video[^>]*class=["\'][^"\']*pd-hero-video-bg[^"\']*["\'][^>]*>/i', function($matches) {
        ...
        if (!preg_match('/\s+poster=/i', $tag)) {
            $tag = preg_replace('/>$/', ' poster="https://primedropelite.com/wp-content/uploads/2026/06/29581450-441b-4c42-b35d-7dd34c864dae-600x750.webp">', $tag);
        }
        return $tag;
    }, $content);
...
add_action('wp_head', function() {
    ...
    /* Hero: poster inmediato y menos bloqueo para equipos lentos */
    body.page-id-14 .pd-hero,
    body.home .pd-hero {
      background-image: linear-gradient(rgba(0,0,0,.36), rgba(0,0,0,.36)), url('https://primedropelite.com/wp-content/uploads/2026/06/29581450-441b-4c42-b35d-7dd34c864dae-600x750.webp') !important;
    ...
    (function() {
      function tune() {
        document.querySelectorAll('.pd-hero video, video.pd-hero-video-bg').forEach(function(video) {
          ...
          if (!video.getAttribute('poster')) video.setAttribute('poster', 'https://primedropelite.com/wp-content/uploads/2026/06/29581450-441b-4c42-b35d-7dd34c864dae-600x750.webp');
          video.muted = true;
...
add_action('wp_head', function() {
    ...
    /* Destacadas: todas las imagenes con el mismo fondo y caja */
    body.page-id-14 .woocommerce ul.products {
      align-items: stretch !important;
    }
