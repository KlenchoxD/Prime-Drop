...
body.page-id-14 .pd-best-carousel-wrap:hover .pd-best-arrow,
body.page-id-14 .pd-best-carousel-wrap:focus-within .pd-best-arrow {
  opacity: .72 !important;
  pointer-events: auto !important;
  transform: translateY(-50%) scale(1) !important;
}

body.page-id-14 .pd-best-arrow:hover {
  opacity: 1 !important;
  background: rgba(0,0,0,.9) !important;
}

body.page-id-14 .pd-best-prev { left: -18px !important; }
body.page-id-14 .pd-best-next { right: -18px !important; }
...
@media (max-width: 767px) {
  ...
  body.page-id-14 .pd-best-prev { left: 2px !important; }
  body.page-id-14 .pd-best-next { right: 2px !important; }
}
...
(function(){
  ...
  function reinforceHeaderLogo(){
    if (document.getElementById('pd-header-logo-style')) return;
    var style = document.createElement('style');
    style.id = 'pd-header-logo-style';
    style.textContent =
  ...
  function hydrateFeaturedProducts(ul) {
    ...
    fetch('/wp-json/wc/store/v1/products?per_page=8&orderby=date&order=desc', {
  ...
  function enhanceBestSellers(){
    ...
    prevArrow.className = 'pd-best-arrow pd-best-prev';
    prevArrow.setAttribute('aria-label', 'Ver productos anteriores');

    var nextArrow = document.createElement('button');
    nextArrow.type = 'button';
    nextArrow.className = 'pd-best-arrow pd-best-next';
    nextArrow.setAttribute('aria-label', 'Ver mas productos');
    ...
    function scrollBest(direction){
      ...
      var target = ul.scrollLeft + (direction * step);
      if (target <= 0) target = 0;
      if (target >= max - 4) target = max;
      ul.scrollTo({ left: target, behavior: 'smooth' });
    }

    prevArrow.addEventListener('click', function(){ scrollBest(-1); });
    nextArrow.addEventListener('click', function(){ scrollBest(1); });
