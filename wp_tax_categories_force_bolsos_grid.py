...
MARKER_START = "/* PRIME_DROP_TAX_CATEGORIES_FORCE_BOLSOS_GRID_START */"
MARKER_END = "/* PRIME_DROP_TAX_CATEGORIES_FORCE_BOLSOS_GRID_END */"
...
def main():
    ...
    session.headers.update({"User-Agent": "PrimeDropTaxCategoriesForceBolsosGrid/1.0"})
    login(session)
    ...
    backup = Path("wp-backups") / f"functions_before_tax_categories_force_bolsos_grid_{datetime.now():%Y%m%d_%H%M%S}.php"
